...
(function(f, exportName) {
    ...
    jskit.getToken = function() {
        ...
        if (params.access_token) {
            ...
            document.cookie = '__USER_INFO_=' + params.access_token + ';' + expires
            return params.access_token;
        }

        var tokenMatch = document.cookie.match(/__USER_INFO_=([^;]*)/);
        if (tokenMatch) {
            return tokenMatch[1];
        }
        return null;
    ...
    jskit.extends(jskit,{
        ...
        toLogin: function(url) {
            ...
            location.href = '/login?ret=' + encodeURIComponent(url);
        },
        /**
         * 打开支付
            ...
            initWechat: function(config, readyCallback) {
                ...
                jskit.jsonp(apiHost+'/api/wchart/getsign', {
                    data: {
                        ...
                        client_id:'100001',
                        signature:'2a849ff5e3cbd4bc97c8aae0099cbd414d1702d9'
                    },
                    cache: false,
                    callback: function(res) {
                        if(res && res.data && res.data.sign_package){
                            var data = res.data.sign_package;
